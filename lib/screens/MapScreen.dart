...
import 'package:flutter_google_maps_task/repository/geo_locator_repository.dart';
import 'package:flutter_google_maps_task/repository/store_data_repository.dart';
...
final dataStoreChangeNotifier = ChangeNotifierProvider<DataRepo>((_ref) {
  return DataRepo();
});
...
class _MapScreenState extends State<MapScreen> {
  ...
  final numberChangeNotifier =
      ChangeNotifierProvider<GeoLocatorRepository>((_ref) {
